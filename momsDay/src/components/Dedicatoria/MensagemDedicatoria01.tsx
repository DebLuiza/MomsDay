  ...
  return (
    <div className='flex items-center justify-center'>
      ...
      <p className="text-lg text-gray-700 mb-4">
        ...
        <br />
        <br />
        Ser mãe é mais do que um título, é uma escolha diária, e você faz isso com uma leveza e força que nos emociona.
        <br />
        <br />
        Como é bom caminhar ao seu lado e poder testemunhar sua paciência, dedicação e carinho.
      </p>
      <p className="text-lg text-gray-700 mb-4">
        Obrigado "VIDA" por ser a mãe/esposa que inspira, acolhe e contagia nossas vidas todos os dias.
        <br />
        <br />
        Amamos você.
      </p>
...
export default MensagemDedicatoria01;
